...
const StyledPersonCoinIcon = styled(PersonCoinIcon)<{
  accentColor?: string
...
function PersonCoinIcon({
  ...
  return (
    <SvgIcon
      ...
      className={`PersonCoinIcon ${className || ''}`.trim()}
      {...props}
    >
      <path
      ...
      />
      <path
        d="M43 36H39C37.9 36 37 36.9 37 38C37 39.1 37.9 40 39 40H41C42.1 40 43 40.9 43 42C43 43.1 42.1 44 41 44H37"
        stroke="#34C0F3"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export default function PersonCoinIconWithAccent(props: BrandIconProps) {
  return (
    <StyledPersonCoinIcon
