import { Canvas, Markdown, Meta, Source } from '@storybook/blocks'
...
<Source
  ...
  dark
  format={true}
  code={`// In your application's root component (e.g., App.tsx, main.tsx)
...
The `colorSchemes` option lets you automatically switch between light and dark themes based on the user's system preference:
...
<Source dark code={`<ThemeProvider theme={betanxtTheme} defaultMode="dark">
  <CssBaseline enableColorScheme />
  {children}
</ThemeProvider>
`} />
